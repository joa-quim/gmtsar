 ...
 * 07/15/08   added a command-line option to force earth radius DTS * 04/26/10
 * added a command-line option to force the number of patches       * merged in
 * ALOSE code by Jeff B and David S					*
...
char *USAGE = "\n\nUsage: ALOS_pre_process imagefile LEDfile [-near near_range] [-radius "
              "RE] [-swap] [-V] [-debug] [-quiet] \n"
              ...
              "-LED                   write GMTSAR generic LED format output and update "
              "PRM (default) \n"
              ...
              "-chirp_ext chirp_ext           force a value for the chirp extension "
              "(integer)\n"
              "-tbias     tbias               correct the clock bias (positive value "
              "means plus)\n"
              "Example:\n"
              "ALOS_pre_process  IMG-HH-ALPSRP050420840-H1.0__A "
              "LED-ALPSRP050420840-H1.0__A \n";
