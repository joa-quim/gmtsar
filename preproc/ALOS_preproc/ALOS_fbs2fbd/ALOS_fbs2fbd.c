...
char *USAGE = "ALOS_FBS2FBD FBS.PRM FBD.PRM \n"
              "  FBS.PRM   PRM file for input  image in fine beam single "
              "polarization (FBS 28 MHz) (input) \n"
              "  FBD.PRM   PRM file for output image in fine beam "
              "HH-polarization (FBD 14 MHz) (output) \n";
...
int main(int argc, char **argv) {
	...
	if (debug)
		fprintf(stderr, " nffti %d nffto %d \n", nffti, nffto);
